...
class TestingPipeline:
    ...
    def setup_directories(self):
        ...
        dirs = [
            'output1/test_results',    # Test sonuçları
            'output1/detailed_results', # Detaylı sonuçlar
            'output1/reports',         # Final raporlar
            'logs'                    # Log dosyaları
        ]
    ...
    def test_all_keys(self):
        ...
        key_files = list(Path("output1/keys").glob("*.txt"))
        
        if not key_files:
            print("❌ HATA: output1/keys/ klasöründe anahtar dosyası bulunamadı!")
        ...
        for key_file in key_files:
            ...
            for threshold in [0.01, 0.05]:
                ...
                # Detaylı CSV dosyası
                csv_file = f"output1/detailed_results/{combo_name}_threshold_{threshold_str}_detailed.csv"
                ...
                simple_csv_file = f"output1/test_results/{combo_name}_threshold_{threshold_str}.csv"
    ...
    def generate_detailed_final_report(self, detailed_results, start_time):
        ...
        # Final detaylı CSV
        detailed_file = "output1/reports/detailed_experiment_results.csv"
        ...
        simple_file = "output1/reports/final_experiment_results.csv"
    ...
    def print_best_worst_combinations(self, df):
        ...
        print(f"   - Detaylı rapor: output1/reports/detailed_experiment_results.csv")
        print(f"   - Basit rapor: output1/reports/final_experiment_results.csv")
        print(f"   - Bireysel detaylı CSVler: output1/detailed_results/")
        print(f"   - Bireysel basit CSVler: output1/test_results/")
